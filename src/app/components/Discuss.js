                ...
                <div className="bg-white w-full lg:w-[50%] rounded-xl shadow-xl min-h-[244px] flex flex-col items-end p-2">
                    <form className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-4 w-full p-2 sm:p-5">
                        ...
                        <div className="flex flex-col space-y-1 pb-1 border-b-2">
                            ...
                            <input id="fullName" type="text" className="text-xs sm:text-base focus:outline-none w-full placeholder-black" placeholder="My Name" />
                        </div>
                        ...
                        <div className="flex flex-col space-y-1 pb-1 border-b-2">
                            ...
                            <div className="text-xs sm:text-base flex items-center gap-1 sm:gap-2">
                                ...
                                <input id="phoneNumber" type="tel" className="flex-grow w-full focus:outline-none placeholder-black" placeholder="+91 0000000000" />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-1 pb-1 border-b-2">
                            ...
                            <input id="businessName" type="text" className="text-xs sm:text-base w-full focus:outline-none placeholder-black" placeholder="ABC Technologies PVT LTD" />
                        </div>

                        {/* Business Mail input */}
                        <div className="flex flex-col space-y-1 pb-1 border-b-2">
                            <label className="text-[11px] sm:text-[13px] font-medium text-gray-500" htmlFor="businessMail">Business Mail</label>
                            <input id="businessMail" type="email" className="text-xs sm:text-base w-full focus:outline-none placeholder-black" placeholder="demoaccount@gmail.com" />
                        </div>
                    </form>
